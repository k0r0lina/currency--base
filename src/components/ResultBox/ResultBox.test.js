...
import { formatAmountInCurrency } from '../../utils/formatAmountInCurrency.js';
  ...
  describe('Component ResultBox', () => {
    ...
    it('should render proper info about conversion when PLN -> USD', () => {
        ...
        // check if output callback was called with proper argument
    ...
    it('should have the same value if conversion type USD-USD', () => {
    ...
    it('should have the same value if conversion type PLN-PLN', () => {
